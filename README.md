# [hamedakbari.vercel.app](https://hamedakbari.vercel.app/)
...
- **`src/data/*`** - JSON files containing data for projects and the [`uses`](https://hamedakbari.vercel.app//uses) page
...
Create a `.env` file similar to [`.env.example`](https://github.com/hamedakbarii/hamedakbari.me/blob/main/.env.example).
...
Please review the [license](https://github.com/hamedakbarii/hamedakbari.me/blob/main/LICENSE), do not copy it directly, remove all of my personal content and files (resume, blog posts, images, etc.) by running `yarn setup` and please change the styling and colors to match your personal brand. You are free to use this code as inspiration or learning reference but this is not really intended to be a template.
